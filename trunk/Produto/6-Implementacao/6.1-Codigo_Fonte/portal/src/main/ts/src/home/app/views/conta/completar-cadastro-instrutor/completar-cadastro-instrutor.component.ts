...
@Component({
  selector: 'completar-cadastro-instrutor',
  templateUrl: './completar-cadastro-instrutor.component.html',
  styleUrls: ['./completar-cadastro-instrutor.component.css']
})
export class CompletarCadastroInstrutorComponent implements OnInit
{
  /*-------------------------------------------------------------------
   *                           ATTRIBUTES
   *-------------------------------------------------------------------*/
