...
@Component({
  selector: 'criar-conta-instrutor',
  templateUrl: './criar-conta-instrutor.component.html',
  styleUrls: ['./criar-conta-instrutor.component.css']
})
export class CriarContaInstrutorComponent implements OnInit
{
  /*-------------------------------------------------------------------
   *                           ATTRIBUTES
   *-------------------------------------------------------------------*/
  ...
  public save(): void
  {
    ...
    Broker.of("usuarioService").promise('insertInstrutor', this.usuario, this.usuario.fileTransfer)
      .then((result) => {
